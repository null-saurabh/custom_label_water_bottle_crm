...
import 'package:clwb_crm/screens/client/screens/edit_client/edit_client_controller.dart';
import 'package:clwb_crm/screens/leads/widgets/add_lead_dialog/widgets/input_fields.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class EditClientDialog extends GetView<EditClientController> {
  final ClientModel client;
  const EditClientDialog( {super.key,required this.client});

  @override
  Widget build(BuildContext context) {
    Get.put(EditClientController(client));
...
class _BasicInfoSection extends GetView<EditClientController> {
  @override
  Widget build(BuildContext context) {
    return _Section(
      title: 'Business Info',
...
class _ContactInfoSection extends GetView<EditClientController> {
  @override
  Widget build(BuildContext context) {
    return _Section(
      title: 'Contact Info',
...
class _LocationSection extends GetView<EditClientController> {
  @override
  Widget build(BuildContext context) {
    return _Section(
      title: 'Location',
